<template>
  <Form @submit.prevent="handleSubmit(onSubmit)" :validation-schema="schema" v-slot="{errors}" class="pa-8"
    ...
    <span class="">Already have an account. <router-link :to="{name:'login'}">Click here</router-link> to login.</span>
  </Form>
</template>
<script setup>
