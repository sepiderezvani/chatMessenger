<template>
 ...
 <v-sheet width="380" class="mx-auto">
   <Form @submit.prevent="handleSubmit(onSubmit)" :validation-schema="schema" v-slot="{errors}" class="pa-7" style="box-shadow: 1px 2px 5px #333;border-radius: 25px">
<v-alert
    v-if="success"
type="success"
...
></v-alert>
    <div class='v-col-12 pa-0 mb-3' style=""><h2 class="mx-auto v-col-3 pa-1" style=""> login</h2></div>
     ...
     <span class="pa-1">Don't have any account! <router-link to="/signUp"> Click here </router-link> to singup.</span>
   </Form>
 </v-sheet>
  </v-container>
</template>
